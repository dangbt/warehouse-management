...
- Name: warehouse-flow.spec.ts >> Warehouse Management - Full E2E Flow >> Authenticated flows >> Navigate to ingredients via sidebar
- Location: e2e/warehouse-flow.spec.ts:45:5
