    ...
    data: {
      ...
      permissions: {
        create: [
          ...
          { resource: 'stocktake', action: 'complete' },
          { resource: 'purchase_returns', action: 'read' },
          { resource: 'purchase_returns', action: 'create' },
          { resource: 'supplier_payments', action: 'read' },
          { resource: 'supplier_payments', action: 'create' },
          { resource: 'processing', action: 'read' },
          { resource: 'processing', action: 'create' },
          { resource: 'processing', action: 'complete' },
        ],
      },
    },
  });
