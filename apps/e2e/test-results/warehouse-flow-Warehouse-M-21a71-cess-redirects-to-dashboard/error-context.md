...
- Name: warehouse-flow.spec.ts >> Warehouse Management - Full Flow >> Authentication >> login success redirects to dashboard
- Location: tests/warehouse-flow.spec.ts:16:9
...
> 18  |       await page.fill('input[type="email"]', ADMIN.email)
  ...
  41  |       await page.locator('[class*="win-tree"] >> text=Nguyên liệu').click()
