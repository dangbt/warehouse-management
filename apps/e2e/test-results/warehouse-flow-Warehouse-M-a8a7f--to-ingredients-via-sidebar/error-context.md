...
- Name: warehouse-flow.spec.ts >> Warehouse Management - Full Flow >> Authenticated flows >> Navigate to ingredients via sidebar
- Location: tests/warehouse-flow.spec.ts:40:9
